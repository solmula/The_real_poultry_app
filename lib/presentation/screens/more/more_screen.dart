...
class MoreScreen extends StatelessWidget {
                ...
                SliverPadding(
                  ...
                  sliver: SliverList(
                    delegate: SliverChildListDelegate([
                      ...
                      // ── Operations ──────────────────────────────────────
                      _SectionHeader(label: 'Operations', isDark: isDark),
                      ...
                      _MenuTile(
                        ...
                        title: 'Feed & Water',
                        subtitle: 'Hopper levels, water tanks, pump states',
                        isDark: isDark,
                        badge: _feedWaterBadge(live),
                      ...
                      _MenuTile(
                        ...
                        subtitle: 'Fan, heater, lights, feeder, pump controls',
                        isDark: isDark,
                      ...
                      // ── System ──────────────────────────────────────────
                      _SectionHeader(label: 'System', isDark: isDark),
                      const SizedBox(height: 10),
                      ...
                      _MenuTile(
                        ...
                        title: 'System Status',
                        subtitle: 'Node A/B health, sensors, manure belts',
                        isDark: isDark,
                        badge: anyNodeOffline ? 'OFFLINE' : null,
                        badgeColor: AppColors.statusCritical,
                        onTap: () => _push(context, const SystemStatusScreen()),
                      ),
                      const SizedBox(height: 10),
                      ...
                      _MenuTile(
                        ...
                        subtitle: auth.isAdmin
                            ? 'Thresholds, light schedule, notifications, profile'
  ...
  // Returns a warning badge string if any feed/water is low
  String? _feedWaterBadge(LiveDataProvider live) {
    final d = live.data;
    ...
    final critical = h1Water < 20 || h2Water < 20 || h1Feed < 10 || h2Feed < 10;
    final warning = h1Water < 50 || h2Water < 50 || h1Feed < 30 || h2Feed < 30;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(12),
        border: Border.all(
            color: AppColors.statusCritical.withOpacity(0.3)),
      ),
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              '$offlineNodes offline — check hardware',
              style: const TextStyle(
                fontSize: 13,
                fontWeight: FontWeight.w600,
